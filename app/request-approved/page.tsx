...
export default function RequestApprovedPage() {
  ...
  return (
    <div 
      className="bg-[#5A012A] flex flex-col gap-[48px] items-center pt-0 min-h-screen relative w-full overflow-x-hidden"
      style={{
        paddingLeft: '24px',
        paddingRight: '24px',
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Sie haben die Diensttausch-Anfrage erfolgreich angenommen.
          </p>
          <div 
