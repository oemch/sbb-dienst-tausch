...
export default function TauschAbgelehntPage() {
  ...
  return (
    <div className="bg-[#f3f2f2] flex flex-col min-h-screen w-full">
      ...
      <div className="px-6 pt-[24px] pb-[120px]">
        <div className="bg-white rounded-[12px] shadow-[2px_4px_6px_0px_rgba(0,0,0,0.1),-2px_-2px_6px_0px_rgba(0,0,0,0.1)] flex flex-col items-center gap-[16px] px-[16px] py-[48px]">
          <div className="flex items-center justify-center size-[36px] rounded-full bg-[#fdecea]">
          ...
          <p className="text-[16px] font-normal text-black leading-[1.5] text-center">
            Du hast den Tausch abgelehnt. Luca Meier wird entsprechend informiert.
          </p>
        </div>
      </div>
