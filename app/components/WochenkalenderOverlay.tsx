  ...
  return (
    <>
      ...
      {overlayState === 1 && (
        <button
          onClick={handleClick}
          className={`absolute inset-0 z-[200] w-full h-full cursor-pointer transition-opacity duration-500 ease-out ${
      ...
      {overlayState === 2 && (
        <div
          className={`absolute inset-0 z-[200] w-full h-full pointer-events-none transition-opacity duration-500 ease-out ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
        >
          <div
      ...
      <div
        className="fixed left-[24px] right-[24px] z-[210] pointer-events-auto"
        style={{
